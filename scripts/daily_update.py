...
def log(msg: str) -> None:
    ...
    stamp = dt.datetime.now().strftime("%Y-%m-%d %H:%M:%S")  # noqa: DTZ005 - local wall clock is intentional
...
def today() -> dt.date:
    ...
    return dt.date.today()  # noqa: DTZ011 - local calendar day is intentional
